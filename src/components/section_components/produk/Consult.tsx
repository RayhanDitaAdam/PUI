    ...
    <div className="w-full flex justify-center bg-white pb-10 md:py-10">
      <div className="pui-wrap mt-32 md:mt-10 overflow-visible lg:!max-w-[1200px] xl:!max-w-[1350px]">
        <div className="mx-[1rem] hero flex flex-col md:flex-row-reverse items-start md:items-end gap-0 md:gap-8 pt-4 pb-0 px-8 md:p-12 md:pb-0 text-left md:text-left isolate">
          ...
          <div className="hero-img-wrap flex-shrink-0 w-full md:w-auto flex justify-end items-end relative z-0 pointer-events-none">
            <div className="hero-person-placeholder relative h-[7.5rem] md:h-[20rem] overflow-visible">
              <img
                className="w-full h-auto pointer-events-none scale-[0.65] md:scale-[0.6] lg:scale-[0.8] lg:w-[25rem] origin-bottom translate-x-[4.75rem] -translate-y-[1rem] md:translate-x-0 md:translate-y-4 transition-transform duration-300"
          ...
          <div className="md:pl-0 mr-8 md:mr-0 lg:mr-0 md:-mb-5 lg:p-5 lg:mt-20 md:p-1 hero-content relative z-[50] md:z-10 -mt-[19.375rem] flex flex-col items-start w-full md:w-[21.25rem] pb-10 md:pb-10 md:bottom-10">
            <h6 className="text-[1.25rem] lg:text-[2.125rem] md:text-[1.875rem] font-bold text-[#EDE8D0] leading-snug md:leading-tight mb-4 md:mb-[0.875rem] max-w-[11.875rem] md:max-w-full md:px-0">
            ...
            <button className="btn-wa animate-pulse-whatsapp flex items-center justify-center gap-2 bg-[#008774] border border-white/20 text-white w-full md:w-auto px-6 py-3.5 md:px-5 md:py-3 rounded-xl text-base md:text-sm font-semibold relative z-[60] pointer-events-auto">
        ...
        <div className="bg-white relative z-20">
          <div className="mx-[1rem] grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 lg:-mt-[1.1rem] md:mt-[-3.75rem] !bg-white pt-2 pb-4 md:py-4 rounded-b-xl md:rounded-b-2xl border-x md:border-none border-b md:border-none border-gray-200 relative z-10" style={{ backgroundColor: 'white' }}>
            <div className="card bg-white border border-gray-200 md:border-gray-200 rounded-xl p-4 md:p-7 flex flex-col">
              <div className="card-icon-wrap w-9 h-9 md:w-12 md:h-12 bg-[#C49A6C] rounded-lg md:rounded-xl flex items-center justify-center mb-3 md:mb-5">
                <img src="/assets/img/81829e2cbb1d51f007adb0e183c5911e296267be.webp" width="1.5rem" className="brightness-0 w-[1.125rem] md:w-[1.5rem]" />
              </div>
            ...
            <div className="card bg-white border border-gray-200 md:border-gray-200 rounded-xl p-4 md:p-7 flex flex-col">
              <div className="card-icon-wrap w-9 h-9 md:w-12 md:h-12 bg-[#C49A6C] rounded-lg md:rounded-xl flex items-center justify-center mb-3 md:mb-5">
                <img src="/assets/img/d8d020e2c5ce16700e20195204cc0d38d6ba12bb.webp" width="1.5rem" className="brightness-0 w-[1.125rem] md:w-[1.5rem]" />
              </div>
