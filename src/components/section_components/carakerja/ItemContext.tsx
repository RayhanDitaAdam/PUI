                    ...
                    <div className="relative w-full block md:hidden">
                        <div className="grid grid-cols-1 relative z-10 w-full min-h-[500px]">
                            {[
                                ...
                                { id: "06", title: "Penerbitan & Pembiayaan", desc: "Nasabah menerima hasil analisis/ sertifikasi dan dapat langsung melanjutkan proses gadai dengan pencairan dana cepat", idx: 11 }
                            ].map((step) => (
                                <div 
                                    key={step.id} 
                                    ref={el => { stepsRef.current[step.idx] = el; }} 
                                    style={{ gridArea: "1 / 1 / 2 / 2" }}
                                    className="step-item relative z-10 p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.06)] bg-white/40 backdrop-blur-md border border-white/60"
                                >
                                    <h2 className="text-3xl font-extrabold text-[#003B33] mb-5">{step.id}</h2>
