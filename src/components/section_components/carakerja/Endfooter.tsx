let Endfooter = function () {
    ...
    shadow-lg px-6 py-4 rounded-xl w-[320px]">
                        ...
                        <img
                            src="/assets/img/carakerja/976bcb699eee62365f73346a6cc9c54906a407b5.webp"
                            className="h-auto"
                            width="100"
                         alt="image" />
                    </div>
    ...
    shadow-lg px-6 py-4 rounded-xl w-[320px]">
                        <img
                            src="/assets/img/carakerja/09dd06d3deee0d04947fcc24e3c35ec5d9e191e3.webp"
                            className="h-auto"
                            width="100"
                         alt="image" />
                    </div>
                    <div className="flex justify-center items-center gap-4 
                        ...
                        w-[320px]">
                        <img
                            src="/assets/img/carakerja/60801985fc03ada13d72d3999781a82323267511.webp"
                            width="50"
                         alt="image" />
            ...
            <div>
                <div className="w-full">
                    <img src="/assets/img/carakerja/b1f2109c3a1758ec231d48590ba9d6dc545b51b6.webp"  alt="image" />
                </div>
            </div>
            <div
                style={{
            ...
            >
                <div className="grid grid-cols-4 gap-12 mb-12">
                    <div>
                        <img src="/assets/img/carakerja/logo-pui.webp" className="w-[160px]"  alt="Logo Pui" />
                ...
                <div className="flex items-center gap-6 mb-8">
                    <div className="flex gap-3 p-3 bg-white/5 rounded">
                        <img width="60" src="/assets/img/carakerja/logo-ojk.webp"  alt="Logo Ojk" />
                        <span className="font-medium">
                            Terdaftar & diawasi OJK
                        </span>
                    </div>
                    <div className="flex gap-3 p-3 bg-white/5 rounded">
                        <img width="90" src="/assets/img/carakerja/d8a28cc7d63c61e6d01f7699200f9f7a096d9c27.webp"  alt="image" />
                        <span className="font-medium">
                            Anggota Resmi PPGI
                        </span>
                    </div>
