      ...
      <div className="pui-wrap mt-28">
        <div className="hero">
          ...
          <div className="hero-img-wrap">
            <div className="hero-person-placeholder" data-aos="fade-up">
              <img className="-mb-44" src="/assets/img/carakerja/40d826a68f7b2fe6a3460b18c5d0de6a1118d609.png" />
            </div>
          </div>
        </div>
        ...
        <div className="cards-row top-10 mb-24">
          <div className="card" data-aos="fade-right">
            <div className="card-icon-wrap_1 bg-gradient-to-r from-[#0E2B25] to-[#0C816B]">
              <img style={{ filter: "brightness(0) invert(1)" }} src="/assets/img/carakerja/81829e2cbb1d51f007adb0e183c5911e296267be.png" width="24px" />
            </div>
          ...
          <div className="card" data-aos="fade-left">
            <div className="card-icon-wrap_1 bg-gradient-to-r from-[#0E2B25] to-[#0C816B]">
              <img style={{ filter: "brightness(0) invert(1)" }} src="/assets/img/carakerja/d8d020e2c5ce16700e20195204cc0d38d6ba12bb.png" width="24px" />
            </div>
