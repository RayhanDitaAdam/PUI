  ...
  return (
    <div className="w-full flex justify-center bg-white pb-10 md:py-10">
      <div className="pui-wrap mt-32 md:mt-10 overflow-visible lg:!max-w-[1200px] xl:!max-w-[1350px]">
        ...
        <div className="mx-[1rem] grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mt-[1.5rem] lg:-mt-[1.1rem] md:mt-[-3.75rem] bg-white py-4 md:p-0 rounded-b-xl md:rounded-b-2xl border-x md:border-none border-b md:border-none border-gray-200 relative z-10">
