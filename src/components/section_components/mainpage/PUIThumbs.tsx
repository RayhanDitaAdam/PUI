    ...
    return (
        <div id="vision" className="bg-white gsap-reveal">
            <div className="text-center py-16 md:py-24 px-6 md:px-0">
                ...
                <div>
                    <h1 className="py-3 text-xl md:text-4xl text-[#030303] font-thin">Pencairan Aset Terpercaya</h1>
                ...
                <div className="flex justify-center -mb-8 md:-mb-16">
                    <img className="w-full md:w-[1200px] h-auto object-contain" src="/assets/img/63959d55c77b0ac1ccf433618f2f6ac32f199cd6.webp"  alt="image" />
                </div>
            </div>
        </div>
    );
