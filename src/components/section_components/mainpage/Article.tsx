  ...
  return (
    <section className="bg-white py-10 px-6 md:px-16 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
        ...
        <a href="#" className="flex items-center gap-2 text-[#008774] font-bold text-sm hover:underline">
          Lihat Selengkapnya 
        ...
        {articles.map((item) => (
          ...
          >
            ...
            <div className="py-4 flex flex-col flex-grow">
              ...
              <a href="#" className="mt-auto flex items-center gap-2 text-[#008774] font-bold text-xs hover:gap-3 transition-all">
                Read More
