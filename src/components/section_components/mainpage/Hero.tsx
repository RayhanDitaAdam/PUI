...
let Hero: React.FC = () => {
  ...
  return (
    <section className="z-10 relative w-full h-auto min-h-[39rem] md:h-[53.125rem] lg:h-[45rem] overflow-hidden">
      <div className="relative h-full min-h-[39rem] md:h-[53.125rem] lg:h-[45rem] rounded-b-[1.875rem] md:rounded-b-[3.125rem] shadow-lg overflow-hidden">
        ...
        <div className="md:hidden relative z-20 flex flex-col items-center pt-[8.75rem] pb-16 px-6">
          ...
          <div className="mt-[17rem] w-full flex flex-col gap-4 items-center">
          ...
          {/* PUI Info Card */}
          <div className="mt-10 text-center flex flex-col items-center max-w-[90%] sm:max-w-sm bg-black/80 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.1),inset_0_1px_0_0_rgba(255,255,255,0.2)] backdrop-blur-[8px] rounded-[1.5rem] p-6 sm:p-8">
