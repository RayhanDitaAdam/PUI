                    ...
                    {products.map((item, i) => (
                        ...
                        >
                            ...
                            <div className="mx-[0.5rem] p-1 mt-1 md:mx-[1.06rem] md:mt-2 z-[100] text-left flex flex-col flex-grow relative">
                                ...
                                <a href="https://pui-xi.vercel.app/detail/produk#" className="hover-premium-btn mt-auto text-center text-[10px] md:text-sm border-2 border-[#5C5E3D] mb-[1.56rem] md:mb-[2rem] font-bold text-[#C49A6C] px-2 md:px-4 py-1.5 md:py-2 rounded-lg md:rounded-[15px] bg-[#C49A6C30]">
