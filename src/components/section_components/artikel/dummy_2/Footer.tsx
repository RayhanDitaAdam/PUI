            ...
            <div className="w-full -mt-10">
                ...
                >
                    <div className="grid grid-cols-4 gap-12 mb-12">
                        <div>
                            <img src="/assets/img/main/logo-pui.png" className="w-[160px]" />
                    ...
                    <div className="flex items-center gap-6 mb-8">
                        <div className="flex gap-3 p-3 bg-white/5 rounded">
                            <img width="60" src="/assets/img/main/logo-ojk.png" />
                            <span className="font-medium">
                                Terdaftar & diawasi OJK
                            </span>
                        </div>
                        <div className="flex gap-3 p-3 bg-white/5 rounded">
                            <img width="90" src="/assets/img/main/d8a28cc7d63c61e6d01f7699200f9f7a096d9c27.png" />
                            <span className="font-medium">
                                Anggota Resmi PPGI
                            </span>
                        </div>
