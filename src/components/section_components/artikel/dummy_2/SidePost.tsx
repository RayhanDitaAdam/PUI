let SidePost = function () {
    return (
        <div className="col-span-4 border-l border-gray-100 pl-8 sticky top-32 h-fit">
            <h3 className="font-bold text-base mb-6 border-b border-gray-200 pb-2">Pos Artikel Terbaru</h3>

            <div className="mb-5">
                <h4 className="font-bold text-sm mb-1">Lorem Ipsum is Simple</h4>
                <p className="text-xs text-gray-500 mb-1 leading-relaxed">Lorem Ipsum is simply dummy text of the printing and typesetting...</p>
            ...
            <div className="mt-8 mb-6">
                ...
                <div className="bg-black text-white p-4 rounded-lg flex items-center justify-center gap-3">
                    <img width="200" src="/assets/logo-pui.png" />
                </div>
            ...
            <div>
                ...
                <div className="flex gap-4 text-[#008774]">
